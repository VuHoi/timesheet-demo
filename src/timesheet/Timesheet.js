...
class Timesheet extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <div className={"space"}>
          <label><input type={"checkbox"} onChange={ev => this.changeBusiness()} ref={el => this.checkboxBusiness = el} /> Show only business hours</label>
          <label><input type={"checkbox"} onChange={ev => this.changeSummary()} ref={el => this.checkboxSummary = el} /> Show daily totals</label>
        </div>
        <DayPilotScheduler
          {...config}
          ref={component => {
